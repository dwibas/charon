...
export const LLM_PROVIDER = process.env.LLM_PROVIDER || 'openai_compatible';
...
export const CODEX_CLI_TIMEOUT_MS = Number(process.env.CODEX_CLI_TIMEOUT_MS || process.env.LLM_TIMEOUT_MS || 45_000);
